...
def main(base, proximity, rank, ratio, size, threshold, verbose):
    ...
    conf = {
        ...
        'zeit.recommend.svd.normalize': True,
    ...
    # woot?!
    # goal[0] = (goal[0][0], rb.cols[5:10]+ [rb.cols[15]])
